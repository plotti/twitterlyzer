...
project = Project.find_by_name("lawyer")
...
puts "AT connections that are found in normal but missing in solr #{normal_missing.count}"
puts "AT connections that are found in solr but missing in normal #{solr_missing.count}"
puts "AT connections that are found in both #{normal_matching.count}"
...
solr_at_connections = FasterCSV.read("#{RAILS_ROOT}/analysis/data/solr_#{project.id}_rt_connections.csv")
normal_at_connections = FasterCSV.read("#{RAILS_ROOT}/analysis/data/normal_#{project.id}_rt_connections.csv")
